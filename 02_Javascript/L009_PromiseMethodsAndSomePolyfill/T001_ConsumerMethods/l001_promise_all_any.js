...
//     return [group1, group2];   // -> Success Promise([100/200, 300]);
// }


// promiseAny().then((data) => { console.log(data); }).catch((err) => { console.log(err); });

// // Shorthand to write the same thing as above.
// promiseAny().then(console.log).catch(console.log);
