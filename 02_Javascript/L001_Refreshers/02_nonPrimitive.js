...
console.log("Type of fn: " + typeof rVal);
...
// <Object>[x] -> search for the value inside the variable x.
// <object>.x -> It will search for x.
for (let key in cap) {
    console.log("My key is: " + key +
        ", value against it using cap[key]: " + cap[key] + " and using cap.key: " + cap.key);  // Here key is key which I will try to look in object.
}
