...
// var f = 5 / 3;
// console.log("value of f: ", f, "typeof a where content is: " + f + " => " + typeof f);


// 6th statemnet.
var g = [10, 20.5, "abc", 'def', 'g', true, false, [23, 45, "jhk"]];
console.log("Value of g: ", g);
console.log("typeof a where content is: " + g + " => " + typeof g);
