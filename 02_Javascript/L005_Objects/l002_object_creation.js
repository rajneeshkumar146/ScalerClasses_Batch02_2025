...
// P -> Q -> R, Where P, Q and R are the number of elements in P, Q and R object.
// T: O(P + Q + R)
// for(let key in obj3){
//     if(obj3.hasOwnProperty(key)){
//         console.log("My Keys are: ", key);
//     }else if(obj2.hasOwnProperty(key)){
//         console.log("My Parent Keys are: ", key);
//     }else if(obj.hasOwnProperty(key)){
//         console.log("My Grand Parent Keys are: ", key);
//     }
// }

// Question: Can you write a loop to print all members of my object but you need to 
// ignore member of all parent class and so on. And Can you optimize that operations.
